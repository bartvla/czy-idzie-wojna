...
| Natężenie doniesień medialnych | [GDELT DOC 2.0 API](https://api.gdeltproject.org/api/v2/doc/doc?query=Poland%20military&mode=timelinevol&format=json&timespan=30d) | JSON | Limit zapytań (429 przy częstym odpytywaniu). |
